...
class AlumnexOutsideCollegePage extends StatefulWidget {
  final dynamic rollno;
  
  final dynamic roll;

  const AlumnexOutsideCollegePage({super.key,required this.rollno,required this.roll});

  @override
  State<AlumnexOutsideCollegePage> createState() => _AlumnexOutsideCollegePageState();
}

class _AlumnexOutsideCollegePageState extends State<AlumnexOutsideCollegePage> {
  late final rollno;
      ...
      body: FutureBuilder<List<dynamic>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            final posts =
                snapshot.data!
                    .where((post) => post['postType'] == "Outside")
                    .toList();
